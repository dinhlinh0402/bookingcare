...
class DetailSpecialty extends Component {
    ...
    async componentDidMount() {
        if (this.props.match && this.props.match.params && this.props.match.params.id) {
            ...
            // console.log('check res from detailSpecialty: ', res);
            ...
            if (res && res.errCode === 0 && resProvince && resProvince.errCode === 0) {
                ...
                this.setState({
                    ...
                    // listProvince: this.buidlDataInputSelect(resProvince.data)
    ...
    handleOnChangeSelect = async (event) => {
        ...
        if (this.props.match && this.props.match.params && this.props.match.params.id) {
            ...
            if (res && res.errCode === 0) {
                ...
                // console.log('arrDoctorId on change', arrDoctorId)
    ...
    render() {
        ...
        // console.log('arrDoctorId render', arrDoctorId)
        ...
        return (
            <div className="detail-specialty-container">
                ...
                <div className="detail-specialty-body">
                    ...
                    <div className="search-sp-doctor col-4 mt-3 pl-0">
                        {/* <Select
