...
class ManageDoctor extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.allRequiredDoctorInfor !== this.props.allRequiredDoctorInfor) {
            ...
            // console.log('chec arr state: ', Array.isArray(this.props.allRequiredDoctorInfor))
            // console.log('chec arr state: ', this.props.allRequiredDoctorInfor)
            ...
            // console.log('test build:', dataSelectPrice, dataSelectPayment, dataSelectProvince)
    ...
    handleSaveContentMardown = () => {
        ...
        // console.log("check state: ", this.state.contentMarkdown)
    }
    ...
    handleChangeSelect = async selectedOption => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown) {
            ...
            // console.log(`Check res:`, markdown.contentMarkdown);
        } else {
            this.setState({
                contentHTML: '',
                contentMarkdown: '',
