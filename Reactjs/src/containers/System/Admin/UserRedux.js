...
class UserRedux extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        // render => didUpdate
        // So sánh hiện tại (this.props) và quá khứ (prevProps)
    ...
    render() {
        ...
        // console.log("Check gender from UserRedux: ", this.props.genderRedux);
        // console.log("Check position from UserRedux: ", this.props.positionRedux);
        // console.log("Check roles from UserRedux: ", this.props.roleRedux);
