...
const adminReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.FETCH_REQUIRED_DOCTOR_INFOR_SUCCESS:
            ...
            // console.log('check arr: ', Array.isArray(state.allRequiredDoctorInfor.resSpecialty))
            // console.log('>>>fetch required doctor data action: ', state.allRequiredDoctorInfor)
